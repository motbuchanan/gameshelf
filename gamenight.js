...
GN.AVATARS=[
 ...
 {id:"gem",set:"Things",svg:'<polygon points="50,22 72,40 50,80 28,40" fill="#fff"/><g stroke="rgba(0,0,0,.22)" stroke-width="2" fill="none"><line x1="28" y1="40" x2="72" y2="40"/><line x1="40" y1="40" x2="50" y2="80"/><line x1="60" y1="40" x2="50" y2="80"/><line x1="40" y1="40" x2="50" y2="22"/><line x1="60" y1="40" x2="50" y2="22"/></g>'},
  {id:"fox",set:"Animals",svg:'<polygon points="30,30 26,14 42,26" fill="#fff"/><polygon points="70,30 74,14 58,26" fill="#fff"/><path d="M30 32 L50 26 L70 32 L62 56 Q50 70 38 56 Z" fill="#fff"/><polygon points="44,58 56,58 50,70" fill="rgba(0,0,0,.3)"/><g fill="rgba(0,0,0,.5)"><circle cx="42" cy="44" r="2.6"/><circle cx="58" cy="44" r="2.6"/></g>'},
  {id:"owl",set:"Animals",svg:'<path d="M28 46 a22 22 0 0 1 44 0 v6 a22 22 0 0 1-44 0 z" fill="#fff"/><polygon points="30,30 38,42 28,42" fill="#fff"/><polygon points="70,30 62,42 72,42" fill="#fff"/><g fill="rgba(0,0,0,.5)"><circle cx="40" cy="46" r="7" fill="#fff"/><circle cx="60" cy="46" r="7" fill="#fff"/><circle cx="40" cy="46" r="3"/><circle cx="60" cy="46" r="3"/></g><polygon points="50,50 46,56 54,56" fill="rgba(0,0,0,.4)"/>'},
  {id:"frog",set:"Animals",svg:'<circle cx="36" cy="34" r="10" fill="#fff"/><circle cx="64" cy="34" r="10" fill="#fff"/><g fill="rgba(0,0,0,.5)"><circle cx="36" cy="34" r="4"/><circle cx="64" cy="34" r="4"/></g><path d="M26 44 a24 18 0 0 0 48 0 z" fill="#fff"/><path d="M38 60 q12 8 24 0" stroke="rgba(0,0,0,.35)" stroke-width="3" fill="none" stroke-linecap="round"/>'},
  {id:"penguin",set:"Animals",svg:'<ellipse cx="50" cy="52" rx="20" ry="26" fill="#fff"/><ellipse cx="50" cy="56" rx="11" ry="18" fill="rgba(0,0,0,.18)"/><g fill="rgba(0,0,0,.5)"><circle cx="44" cy="38" r="2.4"/><circle cx="56" cy="38" r="2.4"/></g><polygon points="46,44 54,44 50,52" fill="rgba(0,0,0,.4)"/>'},
  {id:"lion",set:"Animals",svg:'<g fill="#fff"><circle cx="50" cy="50" r="30" opacity=".5"/><circle cx="50" cy="50" r="22"/></g><g fill="rgba(0,0,0,.5)"><circle cx="42" cy="47" r="2.6"/><circle cx="58" cy="47" r="2.6"/></g><path d="M44 58 q6 6 12 0" stroke="rgba(0,0,0,.4)" stroke-width="2.5" fill="none" stroke-linecap="round"/><circle cx="50" cy="54" r="2.5" fill="rgba(0,0,0,.35)"/>'},
  {id:"elephant",set:"Animals",svg:'<circle cx="50" cy="44" r="22" fill="#fff"/><path d="M30 40 q-14 0 -14 16" fill="none" stroke="#fff" stroke-width="9"/><path d="M70 40 q14 0 14 16" fill="none" stroke="#fff" stroke-width="9"/><path d="M50 56 q-8 0 -8 18" fill="none" stroke="#fff" stroke-width="9" stroke-linecap="round"/><g fill="rgba(0,0,0,.45)"><circle cx="43" cy="42" r="2.4"/><circle cx="57" cy="42" r="2.4"/></g>'},
  {id:"monkey",set:"Animals",svg:'<circle cx="30" cy="40" r="9" fill="#fff"/><circle cx="70" cy="40" r="9" fill="#fff"/><circle cx="50" cy="48" r="22" fill="#fff"/><ellipse cx="50" cy="56" rx="13" ry="11" fill="rgba(0,0,0,.16)"/><g fill="rgba(0,0,0,.5)"><circle cx="43" cy="44" r="2.6"/><circle cx="57" cy="44" r="2.6"/></g>'},
  {id:"pig",set:"Animals",svg:'<circle cx="50" cy="50" r="24" fill="#fff"/><polygon points="32,30 40,40 30,42" fill="#fff"/><polygon points="68,30 60,40 70,42" fill="#fff"/><ellipse cx="50" cy="58" rx="11" ry="8" fill="rgba(0,0,0,.16)"/><g fill="rgba(0,0,0,.45)"><circle cx="46" cy="58" r="2"/><circle cx="54" cy="58" r="2"/><circle cx="43" cy="46" r="2.4"/><circle cx="57" cy="46" r="2.4"/></g>'},
  {id:"cow",set:"Animals",svg:'<path d="M26 36 q-8 -6 -6 8 z" fill="#fff"/><path d="M74 36 q8 -6 6 8 z" fill="#fff"/><circle cx="50" cy="50" r="24" fill="#fff"/><ellipse cx="50" cy="60" rx="13" ry="9" fill="rgba(0,0,0,.16)"/><g fill="rgba(0,0,0,.45)"><circle cx="43" cy="46" r="2.6"/><circle cx="57" cy="46" r="2.6"/></g><path d="M34 32 a8 8 0 0 1 14 4" fill="rgba(0,0,0,.18)"/>'},
  {id:"horse",set:"Animals",svg:'<path d="M40 78 V52 q0-22 22-26 l8-6 4 6 -6 8 q8 8 6 22 l-4 22 -8 0 -2-18 -10 0 -2 18 z" fill="#fff"/><polygon points="62,22 66,12 70,22" fill="#fff"/><circle cx="64" cy="30" r="2" fill="rgba(0,0,0,.5)"/>'},
  {id:"sheep",set:"Animals",svg:'<g fill="#fff"><circle cx="40" cy="46" r="11"/><circle cx="60" cy="46" r="11"/><circle cx="50" cy="40" r="11"/><circle cx="50" cy="54" r="13"/></g><ellipse cx="50" cy="54" rx="8" ry="9" fill="rgba(0,0,0,.16)"/><g fill="rgba(0,0,0,.45)"><circle cx="46" cy="52" r="2"/><circle cx="54" cy="52" r="2"/></g>'},
  {id:"whale",set:"Animals",svg:'<path d="M22 52 q0-16 22-16 q26 0 32 6 q-6 8 -20 8 q14 4 14 12 q-12 4 -20-2 q-10 6 -22 0 q-8-4 -6-8 z" fill="#fff"/><path d="M50 36 q4-10 12-10 q-2 8 -6 10 z" fill="#fff"/><circle cx="34" cy="48" r="2.4" fill="rgba(0,0,0,.5)"/>'},
  {id:"dolphin",set:"Animals",svg:'<path d="M22 58 q4-26 30-30 q18-2 26 6 q-14 0 -20 8 q16 0 20 12 q-14 4 -24-4 q-16 10 -32 8 z" fill="#fff"/><polygon points="48,30 56,18 56,30" fill="#fff"/><circle cx="34" cy="46" r="2.2" fill="rgba(0,0,0,.5)"/>'},
  {id:"octopus",set:"Animals",svg:'<path d="M30 46 a20 20 0 0 1 40 0 v8 h-40 z" fill="#fff"/><g fill="#fff"><path d="M30 54 q-6 14 -10 18"/><path d="M40 56 q-2 16 -6 20"/><path d="M50 57 v22"/><path d="M60 56 q2 16 6 20"/><path d="M70 54 q6 14 10 18"/></g><g fill="rgba(0,0,0,.5)"><circle cx="42" cy="44" r="3"/><circle cx="58" cy="44" r="3"/></g>'},
  {id:"crab",set:"Animals",svg:'<ellipse cx="50" cy="52" rx="20" ry="13" fill="#fff"/><g fill="#fff"><circle cx="30" cy="44" r="6"/><circle cx="70" cy="44" r="6"/></g><g stroke="#fff" stroke-width="4" stroke-linecap="round"><line x1="34" y1="58" x2="26" y2="68"/><line x1="42" y1="62" x2="38" y2="72"/><line x1="58" y1="62" x2="62" y2="72"/><line x1="66" y1="58" x2="74" y2="68"/></g><g fill="rgba(0,0,0,.5)"><circle cx="44" cy="50" r="2.4"/><circle cx="56" cy="50" r="2.4"/></g>'},
  {id:"snail",set:"Animals",svg:'<path d="M22 64 q0-22 22-22 q18 0 18 16 q0 12-12 12 q-8 0-8-8 q0-5 5-5" fill="none" stroke="#fff" stroke-width="6"/><path d="M22 64 q-4 0 -4 6 h14" fill="#fff"/><g stroke="#fff" stroke-width="3"><line x1="20" y1="62" x2="16" y2="52"/><line x1="26" y1="62" x2="24" y2="50"/></g>'},
  {id:"bee",set:"Animals",svg:'<ellipse cx="50" cy="54" rx="16" ry="20" fill="#fff"/><g fill="rgba(0,0,0,.4)"><rect x="34" y="46" width="32" height="5"/><rect x="34" y="58" width="32" height="5"/></g><g fill="rgba(255,255,255,.55)"><ellipse cx="34" cy="40" rx="11" ry="7" transform="rotate(-25 34 40)"/><ellipse cx="66" cy="40" rx="11" ry="7" transform="rotate(25 66 40)"/></g>'},
  {id:"ladybug",set:"Animals",svg:'<circle cx="50" cy="54" r="22" fill="#fff"/><path d="M50 32 V76" stroke="rgba(0,0,0,.4)" stroke-width="3"/><circle cx="50" cy="36" r="7" fill="rgba(0,0,0,.4)"/><g fill="rgba(0,0,0,.35)"><circle cx="40" cy="50" r="3.5"/><circle cx="60" cy="50" r="3.5"/><circle cx="42" cy="64" r="3"/><circle cx="58" cy="64" r="3"/></g>'},
  {id:"spider",set:"Animals",svg:'<circle cx="50" cy="54" r="13" fill="#fff"/><circle cx="50" cy="40" r="7" fill="#fff"/><g stroke="#fff" stroke-width="3" stroke-linecap="round"><line x1="38" y1="50" x2="22" y2="44"/><line x1="38" y1="56" x2="22" y2="58"/><line x1="38" y1="62" x2="24" y2="70"/><line x1="62" y1="50" x2="78" y2="44"/><line x1="62" y1="56" x2="78" y2="58"/><line x1="62" y1="62" x2="76" y2="70"/></g>'},
  {id:"dino",set:"Animals",svg:'<path d="M26 70 q0-30 26-30 q6-10 16-10 q-2 8 -6 10 q14 4 16 18 q6 2 8 10 h-10 q-2-6 -8-6 q-4 12 -16 12 l-2 8 -8 0 2-12 q-10-2 -10-12 z" fill="#fff"/><circle cx="40" cy="44" r="2.2" fill="rgba(0,0,0,.5)"/><g fill="rgba(0,0,0,.18)"><polygon points="46,40 50,32 54,40"/><polygon points="56,42 60,34 64,42"/></g>'},
  {id:"panda",set:"Animals",svg:'<circle cx="32" cy="32" r="9" fill="#fff"/><circle cx="68" cy="32" r="9" fill="#fff"/><circle cx="50" cy="52" r="24" fill="#fff"/><g fill="rgba(0,0,0,.4)"><ellipse cx="41" cy="48" rx="6" ry="8"/><ellipse cx="59" cy="48" rx="6" ry="8"/><circle cx="50" cy="58" r="3.5"/></g>'},
  {id:"cactus",set:"Nature",svg:'<rect x="44" y="34" width="12" height="44" rx="6" fill="#fff"/><path d="M44 52 q-12 0 -12-12 v-4" fill="none" stroke="#fff" stroke-width="8" stroke-linecap="round"/><path d="M56 46 q12 0 12-12 v-2" fill="none" stroke="#fff" stroke-width="8" stroke-linecap="round"/><rect x="40" y="76" width="20" height="6" rx="2" fill="rgba(0,0,0,.25)"/>'},
  {id:"palm",set:"Nature",svg:'<rect x="47" y="46" width="6" height="34" fill="rgba(0,0,0,.3)"/><g fill="#fff"><path d="M50 40 Q30 30 18 38 Q34 36 50 46"/><path d="M50 40 Q70 30 82 38 Q66 36 50 46"/><path d="M50 38 Q44 18 30 14 Q46 24 50 44"/><path d="M50 38 Q56 18 70 14 Q54 24 50 44"/></g><circle cx="50" cy="40" r="5" fill="#fff"/>'},
  {id:"pine",set:"Nature",svg:'<polygon points="50,16 66,40 34,40" fill="#fff"/><polygon points="50,30 70,56 30,56" fill="#fff"/><polygon points="50,46 74,72 26,72" fill="#fff"/><rect x="46" y="72" width="8" height="8" fill="rgba(0,0,0,.3)"/>'},
  {id:"fern",set:"Nature",svg:'<path d="M50 80 Q50 30 50 20" stroke="#fff" stroke-width="3" fill="none"/><g fill="#fff"><path d="M50 30 Q34 28 28 36 Q40 34 50 38"/><path d="M50 38 Q34 38 30 46 Q42 44 50 46"/><path d="M50 46 Q36 48 32 56 Q44 52 50 54"/><path d="M50 30 Q66 28 72 36 Q60 34 50 38"/><path d="M50 38 Q66 38 70 46 Q58 44 50 46"/><path d="M50 46 Q64 48 68 56 Q56 52 50 54"/></g>'},
  {id:"mushroom",set:"Nature",svg:'<path d="M24 50 a26 22 0 0 1 52 0 z" fill="#fff"/><rect x="42" y="50" width="16" height="26" rx="6" fill="#fff"/><g fill="rgba(0,0,0,.22)"><circle cx="38" cy="42" r="4"/><circle cx="58" cy="40" r="5"/><circle cx="50" cy="46" r="3"/></g>'},
  {id:"sunflower",set:"Nature",svg:'<g fill="#fff"><circle cx="50" cy="40" r="8"/><circle cx="50" cy="24" r="6"/><circle cx="50" cy="56" r="6"/><circle cx="34" cy="40" r="6"/><circle cx="66" cy="40" r="6"/><circle cx="39" cy="29" r="6"/><circle cx="61" cy="29" r="6"/><circle cx="39" cy="51" r="6"/><circle cx="61" cy="51" r="6"/></g><circle cx="50" cy="40" r="9" fill="rgba(0,0,0,.3)"/><rect x="48" y="48" width="4" height="30" fill="rgba(0,0,0,.3)"/>'},
  {id:"rose",set:"Nature",svg:'<path d="M50 22 a14 14 0 1 1 -0.1 0 z" fill="#fff"/><path d="M40 36 q10-8 20 0 q-4 8 -10 8 q-6 0 -10-8" fill="rgba(0,0,0,.2)"/><circle cx="50" cy="34" r="5" fill="rgba(0,0,0,.2)"/><rect x="48" y="44" width="4" height="34" fill="rgba(0,0,0,.3)"/><path d="M52 60 q12-2 14-12 q-12 0 -14 12" fill="#fff"/>'},
  {id:"tulip",set:"Nature",svg:'<path d="M38 32 q0-12 12-14 q12 2 12 14 q0 16-12 18 q-12-2 -12-18 z" fill="#fff"/><path d="M50 18 v22 M40 26 v14 M60 26 v14" stroke="rgba(0,0,0,.2)" stroke-width="2"/><rect x="48" y="48" width="4" height="30" fill="rgba(0,0,0,.3)"/><path d="M50 64 q12-2 16-12 q-14 0 -16 12" fill="#fff"/>'},
  {id:"daisy",set:"Nature",svg:'<g fill="#fff"><ellipse cx="50" cy="26" rx="6" ry="11"/><ellipse cx="50" cy="54" rx="6" ry="11"/><ellipse cx="36" cy="40" rx="11" ry="6"/><ellipse cx="64" cy="40" rx="11" ry="6"/><ellipse cx="40" cy="30" rx="6" ry="10" transform="rotate(-45 40 30)"/><ellipse cx="60" cy="30" rx="6" ry="10" transform="rotate(45 60 30)"/><ellipse cx="40" cy="50" rx="6" ry="10" transform="rotate(45 40 50)"/><ellipse cx="60" cy="50" rx="6" ry="10" transform="rotate(-45 60 50)"/></g><circle cx="50" cy="40" r="7" fill="rgba(0,0,0,.3)"/><rect x="48" y="48" width="4" height="30" fill="rgba(0,0,0,.3)"/>'},
  {id:"sprout",set:"Nature",svg:'<path d="M50 80 V46" stroke="#fff" stroke-width="5" stroke-linecap="round"/><path d="M50 52 Q30 50 26 32 Q48 34 50 52" fill="#fff"/><path d="M50 46 Q70 44 74 26 Q52 28 50 46" fill="#fff"/>'},
  {id:"clover",set:"Nature",svg:'<g fill="#fff"><path d="M50 46 Q38 30 50 28 Q62 30 50 46"/><path d="M50 46 Q34 42 38 30 Q52 36 50 46"/><path d="M50 46 Q66 42 62 30 Q48 36 50 46"/><path d="M50 46 Q42 60 50 64 Q58 60 50 46"/></g><path d="M50 50 q2 18 -6 26" stroke="rgba(0,0,0,.3)" stroke-width="3" fill="none"/>'},
  {id:"succulent",set:"Nature",svg:'<g fill="#fff"><ellipse cx="50" cy="44" rx="6" ry="14"/><ellipse cx="36" cy="50" rx="6" ry="13" transform="rotate(-40 36 50)"/><ellipse cx="64" cy="50" rx="6" ry="13" transform="rotate(40 64 50)"/><ellipse cx="42" cy="56" rx="6" ry="12" transform="rotate(-18 42 56)"/><ellipse cx="58" cy="56" rx="6" ry="12" transform="rotate(18 58 56)"/></g><path d="M38 64 h24 l-3 14 h-18 z" fill="rgba(0,0,0,.25)"/>'},
  {id:"bamboo",set:"Nature",svg:'<g fill="#fff"><rect x="38" y="18" width="9" height="60" rx="3"/><rect x="53" y="22" width="9" height="56" rx="3"/></g><g fill="rgba(0,0,0,.25)"><rect x="38" y="34" width="9" height="3"/><rect x="38" y="52" width="9" height="3"/><rect x="53" y="38" width="9" height="3"/><rect x="53" y="56" width="9" height="3"/></g><path d="M47 30 Q62 22 72 28 Q60 32 47 36" fill="#fff"/>'},
  {id:"wheat",set:"Nature",svg:'<path d="M50 80 V36" stroke="#fff" stroke-width="3"/><g fill="#fff"><ellipse cx="50" cy="26" rx="4" ry="8"/><ellipse cx="42" cy="36" rx="4" ry="7" transform="rotate(-30 42 36)"/><ellipse cx="58" cy="36" rx="4" ry="7" transform="rotate(30 58 36)"/><ellipse cx="42" cy="48" rx="4" ry="7" transform="rotate(-30 42 48)"/><ellipse cx="58" cy="48" rx="4" ry="7" transform="rotate(30 58 48)"/><ellipse cx="42" cy="60" rx="4" ry="7" transform="rotate(-30 42 60)"/><ellipse cx="58" cy="60" rx="4" ry="7" transform="rotate(30 58 60)"/></g>'},
  {id:"maple",set:"Nature",svg:'<path d="M50 18 l5 12 10-4 -4 10 12 2 -9 8 5 12 -12-5 -7 9 -7-9 -12 5 5-12 -9-8 12-2 -4-10 10 4 z" fill="#fff"/><rect x="48" y="64" width="4" height="14" fill="rgba(0,0,0,.3)"/>'},
  {id:"acorn",set:"Nature",svg:'<path d="M34 44 a16 14 0 0 1 32 0 z" fill="rgba(0,0,0,.28)"/><path d="M36 44 q14 26 28 0 z" fill="#fff"/><rect x="48" y="22" width="4" height="10" rx="2" fill="rgba(0,0,0,.3)"/>'},
  {id:"lotus",set:"Nature",svg:'<g fill="#fff"><path d="M50 60 Q38 40 50 26 Q62 40 50 60"/><path d="M50 60 Q30 48 30 32 Q46 40 50 60"/><path d="M50 60 Q70 48 70 32 Q54 40 50 60"/><path d="M50 60 Q26 56 22 44 Q42 50 50 60"/><path d="M50 60 Q74 56 78 44 Q58 50 50 60"/></g><path d="M24 64 q26 12 52 0" stroke="rgba(0,0,0,.22)" stroke-width="3" fill="none"/>'},
  {id:"potted",set:"Nature",svg:'<g fill="#fff"><path d="M50 50 Q34 40 32 24 Q48 30 50 50"/><path d="M50 50 Q66 40 68 24 Q52 30 50 50"/><path d="M50 50 V30"/></g><path d="M36 52 h28 l-4 24 h-20 z" fill="#fff"/><rect x="34" y="50" width="32" height="6" rx="2" fill="rgba(0,0,0,.2)"/>'},
  {id:"soccer",set:"Sports",svg:'<circle cx="50" cy="50" r="26" fill="#fff"/><polygon points="50,40 59,47 56,58 44,58 41,47" fill="rgba(0,0,0,.5)"/><g stroke="rgba(0,0,0,.4)" stroke-width="2"><line x1="50" y1="40" x2="50" y2="26"/><line x1="59" y1="47" x2="73" y2="43"/><line x1="56" y1="58" x2="64" y2="70"/><line x1="44" y1="58" x2="36" y2="70"/><line x1="41" y1="47" x2="27" y2="43"/></g>'},
  {id:"basketball",set:"Sports",svg:'<circle cx="50" cy="50" r="26" fill="#fff"/><g stroke="rgba(0,0,0,.45)" stroke-width="2.5" fill="none"><line x1="24" y1="50" x2="76" y2="50"/><line x1="50" y1="24" x2="50" y2="76"/><path d="M31 31 Q50 50 31 69"/><path d="M69 31 Q50 50 69 69"/></g>'},
  {id:"football",set:"Sports",svg:'<ellipse cx="50" cy="50" rx="28" ry="17" fill="#fff"/><line x1="40" y1="50" x2="60" y2="50" stroke="rgba(0,0,0,.4)" stroke-width="3"/><g stroke="rgba(0,0,0,.4)" stroke-width="2"><line x1="44" y1="46" x2="44" y2="54"/><line x1="50" y1="45" x2="50" y2="55"/><line x1="56" y1="46" x2="56" y2="54"/></g>'},
  {id:"baseball",set:"Sports",svg:'<circle cx="50" cy="50" r="26" fill="#fff"/><path d="M33 30 Q44 50 33 70" stroke="rgba(0,0,0,.35)" stroke-width="2" fill="none"/><path d="M67 30 Q56 50 67 70" stroke="rgba(0,0,0,.35)" stroke-width="2" fill="none"/><g stroke="rgba(0,0,0,.3)" stroke-width="1.5"><line x1="36" y1="38" x2="40" y2="40"/><line x1="35" y1="50" x2="40" y2="50"/><line x1="36" y1="62" x2="40" y2="60"/><line x1="64" y1="38" x2="60" y2="40"/><line x1="65" y1="50" x2="60" y2="50"/><line x1="64" y1="62" x2="60" y2="60"/></g>'},
  {id:"tennisball",set:"Sports",svg:'<circle cx="50" cy="50" r="26" fill="#fff"/><path d="M30 32 Q44 50 30 68" stroke="rgba(0,0,0,.3)" stroke-width="3" fill="none"/><path d="M70 32 Q56 50 70 68" stroke="rgba(0,0,0,.3)" stroke-width="3" fill="none"/>'},
  {id:"volleyball",set:"Sports",svg:'<circle cx="50" cy="50" r="26" fill="#fff"/><g stroke="rgba(0,0,0,.4)" stroke-width="2" fill="none"><path d="M50 24 Q40 50 32 73"/><path d="M50 24 Q60 50 68 73"/><path d="M26 44 Q50 56 74 44"/><path d="M28 62 Q50 50 72 62"/></g>'},
  {id:"golf",set:"Sports",svg:'<circle cx="48" cy="46" r="20" fill="#fff"/><g fill="rgba(0,0,0,.16)"><circle cx="42" cy="40" r="2"/><circle cx="50" cy="38" r="2"/><circle cx="56" cy="44" r="2"/><circle cx="44" cy="50" r="2"/><circle cx="52" cy="52" r="2"/></g><path d="M44 66 L52 78 L56 78 L48 64 Z" fill="rgba(0,0,0,.3)"/>'},
  {id:"racket",set:"Sports",svg:'<ellipse cx="44" cy="38" rx="17" ry="21" fill="none" stroke="#fff" stroke-width="5"/><g stroke="rgba(0,0,0,.22)" stroke-width="1.5"><line x1="36" y1="20" x2="36" y2="56"/><line x1="44" y1="18" x2="44" y2="58"/><line x1="52" y1="20" x2="52" y2="56"/><line x1="28" y1="30" x2="60" y2="30"/><line x1="27" y1="40" x2="61" y2="40"/><line x1="28" y1="50" x2="60" y2="50"/></g><rect x="50" y="56" width="7" height="26" rx="3" fill="#fff" transform="rotate(-22 53 69)"/>'},
  {id:"bat",set:"Sports",svg:'<g transform="rotate(42 50 50)"><rect x="46" y="18" width="9" height="46" rx="4.5" fill="#fff"/><rect x="44.5" y="62" width="12" height="16" rx="3" fill="#fff"/><rect x="44" y="74" width="13" height="5" rx="2" fill="rgba(0,0,0,.3)"/></g>'},
  {id:"hockey",set:"Sports",svg:'<path d="M30 22 L40 22 L66 66 L78 66 L78 76 L60 76 L34 32 Z" fill="#fff"/><ellipse cx="40" cy="80" rx="9" ry="4" fill="rgba(0,0,0,.4)"/>'},
  {id:"skate",set:"Sports",svg:'<rect x="20" y="48" width="60" height="9" rx="4" fill="#fff"/><path d="M20 52 q-4 0 -4 4 M80 52 q4 0 4 4" stroke="#fff" stroke-width="4" fill="none"/><g fill="#fff"><circle cx="34" cy="64" r="5"/><circle cx="66" cy="64" r="5"/></g>'},
  {id:"dumbbell",set:"Sports",svg:'<rect x="40" y="45" width="20" height="10" fill="#fff"/><g fill="#fff"><rect x="26" y="36" width="11" height="28" rx="4"/><rect x="63" y="36" width="11" height="28" rx="4"/><rect x="20" y="42" width="8" height="16" rx="3"/><rect x="72" y="42" width="8" height="16" rx="3"/></g>'},
  {id:"whistle",set:"Sports",svg:'<circle cx="42" cy="54" r="15" fill="#fff"/><rect x="52" y="44" width="24" height="13" rx="3" fill="#fff"/><rect x="60" y="40" width="10" height="6" rx="2" fill="#fff"/><circle cx="42" cy="54" r="4" fill="rgba(0,0,0,.4)"/>'},
  {id:"trophy",set:"Sports",svg:'<path d="M38 24 h24 v12 a12 12 0 0 1-24 0 z" fill="#fff"/><path d="M38 28 h-9 a9 9 0 0 0 9 10" fill="none" stroke="#fff" stroke-width="3.5"/><path d="M62 28 h9 a9 9 0 0 1-9 10" fill="none" stroke="#fff" stroke-width="3.5"/><rect x="46" y="48" width="8" height="12" fill="#fff"/><rect x="36" y="60" width="28" height="8" rx="2" fill="#fff"/><rect x="32" y="68" width="36" height="8" rx="2" fill="#fff"/>'},
  {id:"medal",set:"Sports",svg:'<polygon points="40,22 48,46 36,48" fill="rgba(0,0,0,.25)"/><polygon points="60,22 52,46 64,48" fill="rgba(0,0,0,.25)"/><circle cx="50" cy="60" r="17" fill="#fff"/><path d="M50 50 l3.5 7 7.5 1 -5.5 5.5 1.5 7.5 -6.5-4 -6.5 4 1.5-7.5 -5.5-5.5 7.5-1 z" fill="rgba(0,0,0,.3)"/>'},
  {id:"dartboard",set:"Sports",svg:'<circle cx="50" cy="50" r="26" fill="#fff"/><circle cx="50" cy="50" r="19" fill="none" stroke="rgba(0,0,0,.3)" stroke-width="3"/><circle cx="50" cy="50" r="11" fill="none" stroke="rgba(0,0,0,.3)" stroke-width="3"/><circle cx="50" cy="50" r="4" fill="rgba(0,0,0,.45)"/>'},
  {id:"flag",set:"Sports",svg:'<rect x="34" y="20" width="4" height="58" rx="2" fill="#fff"/><g fill="#fff"><rect x="38" y="22" width="9" height="9"/><rect x="56" y="22" width="9" height="9"/><rect x="47" y="31" width="9" height="9"/><rect x="38" y="40" width="9" height="9"/><rect x="56" y="40" width="9" height="9"/></g><rect x="38" y="22" width="27" height="27" fill="none" stroke="rgba(255,255,255,.6)" stroke-width="1.5"/>'},
  {id:"guitar",set:"Music",svg:'<circle cx="42" cy="60" r="20" fill="#fff"/><circle cx="42" cy="60" r="7" fill="rgba(0,0,0,.4)"/><rect x="48" y="22" width="9" height="38" rx="3" fill="#fff" transform="rotate(-32 52 40)"/><rect x="36" y="14" width="13" height="12" rx="2" fill="#fff" transform="rotate(-32 42 20)"/>'},
  {id:"piano",set:"Music",svg:'<rect x="24" y="32" width="52" height="36" rx="4" fill="#fff"/><g fill="rgba(0,0,0,.0)"/><g><rect x="24" y="32" width="52" height="36" rx="4" fill="#fff"/><g fill="rgba(0,0,0,.85)"><rect x="32" y="32" width="5" height="22"/><rect x="41" y="32" width="5" height="22"/><rect x="54" y="32" width="5" height="22"/><rect x="63" y="32" width="5" height="22"/></g><g stroke="rgba(0,0,0,.3)" stroke-width="1.5"><line x1="35" y1="32" x2="35" y2="68"/><line x1="44" y1="32" x2="44" y2="68"/><line x1="50" y1="32" x2="50" y2="68"/><line x1="57" y1="32" x2="57" y2="68"/><line x1="66" y1="32" x2="66" y2="68"/></g></g>'},
  {id:"drum",set:"Music",svg:'<ellipse cx="50" cy="40" rx="26" ry="9" fill="#fff"/><path d="M24 40 v18 a26 9 0 0 0 52 0 V40" fill="#fff"/><g stroke="rgba(0,0,0,.25)" stroke-width="2"><line x1="30" y1="44" x2="36" y2="56"/><line x1="42" y1="47" x2="44" y2="58"/><line x1="58" y1="47" x2="56" y2="58"/><line x1="70" y1="44" x2="64" y2="56"/></g><g stroke="#fff" stroke-width="3" stroke-linecap="round"><line x1="38" y1="34" x2="22" y2="22"/><line x1="62" y1="34" x2="78" y2="22"/></g>'},
  {id:"trumpet",set:"Music",svg:'<path d="M20 50 h34 v-8 h8 v8 h6 a10 12 0 0 1 0 12 h-6 v8 h-8 v-8 h-34 z" fill="#fff"/><g fill="rgba(0,0,0,.3)"><rect x="32" y="40" width="4" height="22"/><rect x="40" y="40" width="4" height="22"/><rect x="48" y="40" width="4" height="22"/></g>'},
  {id:"violin",set:"Music",svg:'<path d="M44 60 q-12 0 -12-12 q0-10 10-10 q-4-6 4-10 q8 4 4 10 q10 0 10 10 q0 12-12 12 z" fill="#fff"/><rect x="46" y="20" width="6" height="26" rx="2" fill="#fff" transform="rotate(-8 49 33)"/><g stroke="rgba(0,0,0,.25)" stroke-width="1.2"><line x1="46" y1="22" x2="44" y2="56"/><line x1="50" y1="22" x2="50" y2="56"/></g>'},
  {id:"mic",set:"Music",svg:'<rect x="40" y="20" width="20" height="34" rx="10" fill="#fff"/><g stroke="rgba(0,0,0,.22)" stroke-width="1.5"><line x1="42" y1="30" x2="58" y2="30"/><line x1="42" y1="38" x2="58" y2="38"/></g><path d="M32 48 a18 18 0 0 0 36 0" fill="none" stroke="#fff" stroke-width="4"/><rect x="47" y="64" width="6" height="14" fill="#fff"/><rect x="40" y="78" width="20" height="5" rx="2" fill="#fff"/>'},
  {id:"headphones",set:"Music",svg:'<path d="M26 56 V48 a24 24 0 0 1 48 0 v8" fill="none" stroke="#fff" stroke-width="5"/><rect x="22" y="54" width="12" height="22" rx="5" fill="#fff"/><rect x="66" y="54" width="12" height="22" rx="5" fill="#fff"/>'},
  {id:"sax",set:"Music",svg:'<path d="M44 20 v26 q0 18 16 18 q12 0 12-12 v-6" fill="none" stroke="#fff" stroke-width="7" stroke-linecap="round"/><path d="M72 46 q10 0 10 12 q0 8-10 8 z" fill="#fff"/><g fill="rgba(0,0,0,.3)"><circle cx="44" cy="34" r="2"/><circle cx="46" cy="44" r="2"/><circle cx="50" cy="54" r="2"/></g>'},
  {id:"brush",set:"Arts",svg:'<rect x="54" y="18" width="9" height="32" rx="3" fill="#fff" transform="rotate(35 58 34)"/><path d="M40 50 q-8 14 -18 20 q10 0 20-10 q8-8 6-16 z" fill="#fff"/>'},
  {id:"palette",set:"Arts",svg:'<path d="M50 24 a26 22 0 1 0 6 52 q-8 0 -8-7 q0-6 6-6 q12 0 12-13 a26 22 0 0 0 -16-26 z" fill="#fff"/><g fill="rgba(0,0,0,.4)"><circle cx="38" cy="38" r="4"/><circle cx="54" cy="34" r="4"/><circle cx="64" cy="46" r="4"/><circle cx="38" cy="56" r="4"/></g>'},
  {id:"camera",set:"Arts",svg:'<rect x="22" y="36" width="56" height="38" rx="6" fill="#fff"/><rect x="38" y="28" width="20" height="10" rx="3" fill="#fff"/><circle cx="50" cy="55" r="13" fill="rgba(0,0,0,.25)"/><circle cx="50" cy="55" r="7" fill="rgba(0,0,0,.4)"/><circle cx="68" cy="44" r="3" fill="rgba(0,0,0,.3)"/>'},
  {id:"clapper",set:"Arts",svg:'<rect x="22" y="42" width="56" height="34" rx="4" fill="#fff"/><path d="M22 42 L78 34 L80 44 L24 52 Z" fill="#fff"/><g fill="rgba(0,0,0,.6)"><polygon points="28,40 36,39 32,49 24,50"/><polygon points="44,38 52,37 48,47 40,48"/><polygon points="60,36 68,35 64,45 56,46"/></g>'},
  {id:"pencil",set:"Arts",svg:'<g transform="rotate(45 50 50)"><rect x="44" y="20" width="12" height="48" fill="#fff"/><polygon points="44,68 56,68 50,82" fill="#fff"/><polygon points="47,74 53,74 50,82" fill="rgba(0,0,0,.5)"/><rect x="44" y="20" width="12" height="8" fill="rgba(0,0,0,.25)"/></g>'},
  {id:"book",set:"Arts",svg:'<path d="M50 28 q-12-6 -24-4 v40 q12-2 24 4 q12-6 24-4 V24 q-12-2 -24 4 z" fill="#fff"/><line x1="50" y1="28" x2="50" y2="68" stroke="rgba(0,0,0,.25)" stroke-width="2.5"/>'},
  {id:"masks",set:"Arts",svg:'<path d="M22 32 q14-4 22 0 q-2 22 -11 26 q-9-4 -11-26 z" fill="#fff"/><path d="M56 42 q14-4 22 0 q-2 22 -11 26 q-9-4 -11-26 z" fill="#fff"/><g fill="rgba(0,0,0,.4)"><circle cx="29" cy="40" r="2.4"/><circle cx="38" cy="40" r="2.4"/><path d="M28 48 q5 4 10 0" stroke="rgba(0,0,0,.4)" stroke-width="2" fill="none"/></g><g fill="rgba(0,0,0,.4)"><circle cx="63" cy="50" r="2.4"/><circle cx="72" cy="50" r="2.4"/><path d="M63 56 q5 -4 10 0" stroke="rgba(0,0,0,.4)" stroke-width="2" fill="none"/></g>'},
  {id:"scissors",set:"Arts",svg:'<circle cx="34" cy="64" r="8" fill="none" stroke="#fff" stroke-width="4"/><circle cx="56" cy="64" r="8" fill="none" stroke="#fff" stroke-width="4"/><line x1="40" y1="58" x2="74" y2="24" stroke="#fff" stroke-width="4" stroke-linecap="round"/><line x1="50" y1="58" x2="26" y2="30" stroke="#fff" stroke-width="4" stroke-linecap="round"/>'},
  {id:"atom",set:"Science",svg:'<circle cx="50" cy="50" r="5" fill="#fff"/><g fill="none" stroke="#fff" stroke-width="3"><ellipse cx="50" cy="50" rx="28" ry="11"/><ellipse cx="50" cy="50" rx="28" ry="11" transform="rotate(60 50 50)"/><ellipse cx="50" cy="50" rx="28" ry="11" transform="rotate(-60 50 50)"/></g>'},
  {id:"telescope",set:"Science",svg:'<rect x="24" y="44" width="44" height="13" rx="3" fill="#fff" transform="rotate(-22 46 50)"/><rect x="60" y="30" width="13" height="16" rx="2" fill="#fff" transform="rotate(-22 66 38)"/><line x1="42" y1="58" x2="42" y2="78" stroke="#fff" stroke-width="4"/><line x1="34" y1="78" x2="50" y2="78" stroke="#fff" stroke-width="4" stroke-linecap="round"/>'},
  {id:"microscope",set:"Science",svg:'<rect x="40" y="20" width="9" height="30" rx="3" fill="#fff" transform="rotate(18 44 35)"/><circle cx="40" cy="22" r="5" fill="#fff"/><path d="M40 52 q-8 8 -6 18" fill="none" stroke="#fff" stroke-width="5"/><rect x="30" y="70" width="40" height="6" rx="3" fill="#fff"/><rect x="44" y="58" width="14" height="6" fill="#fff"/>'},
  {id:"flask",set:"Science",svg:'<path d="M44 22 v18 L28 70 a4 4 0 0 0 4 6 h36 a4 4 0 0 0 4-6 L56 40 V22 z" fill="#fff"/><rect x="40" y="18" width="20" height="5" rx="2" fill="#fff"/><path d="M36 60 h28 l4 8 a4 4 0 0 1-4 6 h-28 a4 4 0 0 1-4-6 z" fill="rgba(0,0,0,.22)"/>'},
  {id:"magnet",set:"Science",svg:'<path d="M30 64 V40 a20 20 0 0 1 40 0 v24 h-13 V40 a7 7 0 0 0-14 0 v24 z" fill="#fff"/><rect x="30" y="64" width="13" height="10" fill="rgba(0,0,0,.4)"/><rect x="57" y="64" width="13" height="10" fill="rgba(0,0,0,.4)"/>'},
  {id:"dna",set:"Science",svg:'<g stroke="#fff" stroke-width="4" fill="none" stroke-linecap="round"><path d="M36 20 Q64 35 36 50 Q64 65 36 80"/><path d="M64 20 Q36 35 64 50 Q36 65 64 80"/></g><g stroke="rgba(255,255,255,.6)" stroke-width="2.5"><line x1="40" y1="26" x2="60" y2="26"/><line x1="44" y1="38" x2="56" y2="38"/><line x1="40" y1="50" x2="60" y2="50"/><line x1="44" y1="62" x2="56" y2="62"/><line x1="40" y1="74" x2="60" y2="74"/></g>'},
  {id:"gear",set:"Science",svg:'<path d="M50 22 l4 0 2 8 6 3 7-5 3 4-5 7 3 6 8 2 0 4 -8 2 -3 6 5 7 -3 4 -7-5 -6 3 -2 8 -4 0 -2-8 -6-3 -7 5 -3-4 5-7 -3-6 -8-2 0-4 8-2 3-6 -5-7 3-4 7 5 6-3 z" fill="#fff"/><circle cx="50" cy="50" r="10" fill="rgba(0,0,0,.4)"/>'},
  {id:"computer",set:"Science",svg:'<rect x="20" y="26" width="60" height="40" rx="4" fill="#fff"/><rect x="26" y="32" width="48" height="28" rx="2" fill="rgba(0,0,0,.35)"/><rect x="40" y="66" width="20" height="6" fill="#fff"/><rect x="32" y="72" width="36" height="5" rx="2" fill="#fff"/>'},
  {id:"gamepad",set:"Science",svg:'<path d="M28 44 h44 a14 14 0 0 1 13 18 l-2 8 a8 8 0 0 1-14 2 l-4-6 h-30 l-4 6 a8 8 0 0 1-14-2 l-2-8 a14 14 0 0 1 13-18 z" fill="#fff"/><g fill="rgba(0,0,0,.4)"><rect x="32" y="52" width="4" height="12"/><rect x="28" y="56" width="12" height="4"/><circle cx="64" cy="54" r="3"/><circle cx="72" cy="60" r="3"/></g>'},
  {id:"bulb",set:"Science",svg:'<path d="M38 50 a14 14 0 1 1 24 0 q-4 6 -5 12 h-14 q-1-6 -5-12 z" fill="#fff"/><rect x="43" y="64" width="14" height="5" fill="rgba(0,0,0,.3)"/><rect x="44" y="70" width="12" height="4" rx="2" fill="rgba(0,0,0,.3)"/>'},
  {id:"tent",set:"Outdoors",svg:'<path d="M50 26 L78 72 H22 Z" fill="#fff"/><path d="M50 40 L62 72 H38 Z" fill="rgba(0,0,0,.3)"/><line x1="50" y1="22" x2="50" y2="30" stroke="#fff" stroke-width="3"/>'},
  {id:"compass",set:"Outdoors",svg:'<circle cx="50" cy="50" r="27" fill="#fff"/><circle cx="50" cy="50" r="27" fill="none" stroke="rgba(0,0,0,.18)" stroke-width="3"/><polygon points="50,32 56,50 50,46 44,50" fill="rgba(0,0,0,.45)"/><polygon points="50,68 44,50 50,54 56,50" fill="rgba(0,0,0,.2)"/>'},
  {id:"mountain",set:"Outdoors",svg:'<polygon points="20,72 42,34 56,56 64,44 80,72" fill="#fff"/><polygon points="42,34 48,43 36,43" fill="rgba(0,0,0,.25)"/>'},
  {id:"bike",set:"Outdoors",svg:'<g fill="none" stroke="#fff" stroke-width="4"><circle cx="30" cy="60" r="13"/><circle cx="70" cy="60" r="13"/></g><g stroke="#fff" stroke-width="3" fill="none"><path d="M30 60 L46 60 L58 38 M46 60 L58 60 M58 38 L70 60 M58 38 L66 38"/></g>'},
  {id:"boot",set:"Outdoors",svg:'<path d="M36 22 h12 v28 q14 2 22 10 q6 6 6 12 h-46 q-6 0 -6-8 V22 z" fill="#fff"/><g stroke="rgba(0,0,0,.25)" stroke-width="2"><line x1="40" y1="30" x2="44" y2="30"/><line x1="40" y1="38" x2="44" y2="38"/></g><rect x="24" y="68" width="52" height="6" rx="2" fill="rgba(0,0,0,.3)"/>'},
  {id:"fishing",set:"Outdoors",svg:'<line x1="26" y1="20" x2="64" y2="66" stroke="#fff" stroke-width="4" stroke-linecap="round"/><path d="M64 66 q6 0 6-8" fill="none" stroke="#fff" stroke-width="3"/><path d="M64 60 a5 7 0 1 0 0.1 0" fill="none" stroke="#fff" stroke-width="3"/><circle cx="32" cy="26" r="4" fill="#fff"/>'},
  {id:"campfire",set:"Outdoors",svg:'<path d="M50 26 q12 12 8 24 q-2 8 -8 10 q-6-2 -8-10 q-4-8 8-24 z" fill="#fff"/><path d="M50 44 q5 6 3 14 q-3 4 -6 0 q-2-8 3-14 z" fill="rgba(0,0,0,.3)"/><g stroke="#fff" stroke-width="4" stroke-linecap="round"><line x1="28" y1="74" x2="72" y2="66"/><line x1="28" y1="66" x2="72" y2="74"/></g>'},
  {id:"anchor",set:"Outdoors",svg:'<circle cx="50" cy="24" r="6" fill="none" stroke="#fff" stroke-width="4"/><line x1="50" y1="30" x2="50" y2="70" stroke="#fff" stroke-width="4"/><line x1="38" y1="40" x2="62" y2="40" stroke="#fff" stroke-width="4"/><path d="M26 54 q0 22 24 18 q24 4 24-18" fill="none" stroke="#fff" stroke-width="4"/>'},
  {id:"kite",set:"Outdoors",svg:'<polygon points="50,20 70,44 50,68 30,44" fill="#fff"/><g stroke="rgba(0,0,0,.25)" stroke-width="2"><line x1="50" y1="20" x2="50" y2="68"/><line x1="30" y1="44" x2="70" y2="44"/></g><path d="M50 68 q4 8 -2 12 q6 2 2 8" fill="none" stroke="#fff" stroke-width="2.5"/>'}
...
let _uid=null,_mockDb=null;
// Factored Firebase init: load SDK, anon sign-in, firestore handle. Reused by household sync AND online rooms.
async function ensureFB(){
  if(typeof window==="undefined")return null;
  if(_mockDb){_db=_mockDb;return _db;}            // tests inject an in-memory store
  if(_db&&_uid)return _db;
  try{
    ...
    _db=firebase.firestore();_uid=firebase.auth().currentUser.uid;
...
const GAME_KEYS=["marble_arcade_games","chess_games","ur_games","sorry_games","checkers_games","c4_games","trouble_games","mancala_games",
  ...
  "farkle_games","knuckle_games","pig_games","paddleduel_games","gofish_games","reversi_games","morris_games",
  "bridge_games","guesswho_games",
  "blackjack_games","solitaire_games","memory_games","gin_games","oldmaid_games",
  "onecardleft_games",
  "snakearcade_games","brickbreak_games","blocks_games","thumbstack_games","stardefender_games",
  "minesweeper_games","gemmatch_games","craps_games","liarsdice_games","ks_games"];
...
async function bootSync(){
  ...
  try{
    const db=await ensureFB();if(!db)return;_hh=hh;
...
/* ---------- online rooms (Firestore-backed; reuses anon auth) ----------
   A room = rooms/{CODE}: { game, host, slots[], seats{slot:{uid,name,...}}, status, turn, seq, state }.
   Model: the device whose turn it is runs the game logic and writes the settled state via
   pushState(); every other device subscribes via watch() and renders what arrives. Turn handoff
   is just the `turn` field flipping. Randomness (dice) is generated by the acting device and
   travels inside `state`, so all devices see the same roll. */
GN.room=(function(){
  const CHARS="ABCDEFGHJKMNPQRSTUVWXYZ23456789"; // no ambiguous 0/O/1/I/L
  function gen(n){let s="";for(let i=0;i<(n||4);i++)s+=CHARS[Math.floor(Math.random()*CHARS.length)];return s;}
  function ref(db,code){return db.doc("rooms/"+code);}
  function meRec(me){return {uid:_uid,name:me.name||"?",color:me.main||me.color||"#888",light:me.light||"#ccc",dark:me.dark||"#333",present:Date.now()};}
  async function create(game,me,opts){
    const db=await ensureFB();if(!db)return{error:"offline"};
    opts=opts||{};const slots=opts.slots||["red","blue"];
    let code="";for(let t=0;t<6;t++){code=gen(opts.codeLen||4);const ex=await ref(db,code).get();if(!ex.exists)break;}
    const seats={};seats[slots[0]]=meRec(me);
    await ref(db,code).set({game:game,host:_uid,slots:slots,seats:seats,status:"lobby",
      turn:slots[0],seq:0,state:null,createdAt:Date.now(),updatedAt:Date.now()});
    return {code:code,seat:slots[0],uid:_uid,host:true};
  }
  async function join(code,me){
    const db=await ensureFB();if(!db)return{error:"offline"};
    code=(code||"").toUpperCase().trim();
    const r=ref(db,code),snap=await r.get();
    if(!snap.exists)return{error:"no-room"};
    const d=snap.data();
    for(const s of d.slots){if(d.seats[s]&&d.seats[s].uid===_uid){
      await r.update({["seats."+s+".present"]:Date.now()});return{code:code,seat:s,uid:_uid,rejoin:true};}}
    const free=d.slots.find(s=>!d.seats[s]);
    if(!free)return{error:"full"};
    const upd={updatedAt:Date.now()};upd["seats."+free]=meRec(me);
    await r.update(upd);
    return{code:code,seat:free,uid:_uid,host:false};
  }
  function watch(code,cb){let stop=function(){};let dead=false;
    ensureFB().then(function(db){if(!db||dead)return;stop=ref(db,code).onSnapshot(function(s){if(s.exists)cb(s.data());});});
    return function(){dead=true;stop();};}
  async function pushState(code,o){
    const db=await ensureFB();if(!db)return;
    const upd={state:o.state,updatedAt:Date.now()};
    if(o.seq!=null)upd.seq=o.seq;
    if(o.turn!=null)upd.turn=o.turn;
    if(o.status!=null)upd.status=o.status;
    await ref(db,code).update(upd);}
  async function start(code,firstSeat,state){
    const db=await ensureFB();if(!db)return;
    await ref(db,code).update({status:"playing",turn:firstSeat,state:state,seq:1,updatedAt:Date.now()});}
  async function presence(code,seat){
    const db=await ensureFB();if(!db)return;
    try{await ref(db,code).update({["seats."+seat+".present"]:Date.now()});}catch(e){}}
  return {create:create,join:join,watch:watch,pushState:pushState,start:start,presence:presence,
    myUid:function(){return _uid;},
    _useMock:function(db,uid){_mockDb=db;_uid=uid;},_gen:gen};
})();
